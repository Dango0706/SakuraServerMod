...
public class Recipes extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> p_251297_) {
        ...
        // 弓
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.STONE_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', Items.COBBLESTONE)
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COBBLESTONE))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.IRON_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', Items.IRON_INGOT)
                .define('b', Items.STICK)
                .define('c', Items.STRING)
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(Items.IRON_INGOT))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.GOLD_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', Items.GOLD_INGOT)
                .define('b', Items.STICK)
                .define('c', Items.STRING)
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(Items.GOLD_INGOT))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.DIAMOND_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', Items.DIAMOND)
                .define('b', Items.STICK)
                .define('c', Items.STRING)
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(Items.DIAMOND))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.NETHERITE_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', Items.NETHERITE_INGOT)
                .define('b', Items.STICK)
                .define('c', Items.STRING)
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(Items.NETHERITE_INGOT))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.RUBY_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', ItemReg.RUBY.get())
                .define('b', Items.STICK)
                .define('c', Items.STRING)
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.RUBY.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.JADEITE_BOW.get())
                .pattern(" ac")
                .pattern("b c")
                .pattern(" ac")
                .define('a', ItemReg.JADEITE.get())
                .define('b', Items.STICK)
                .define('c', Items.STRING)
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.JADEITE.get()))
                .save(p_251297_);
        //大剑
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.WOODEN_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', Items.OAK_PLANKS)
                ...
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.STONE_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', Items.COBBLESTONE)
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.POLE.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.IRON_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', Items.IRON_INGOT)
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.POLE.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.GOLD_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', Items.GOLD_INGOT)
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.POLE.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.DIAMOND_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', Items.DIAMOND)
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.POLE.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.NETHERITE_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', Items.NETHERITE_INGOT)
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.POLE.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.RUBY_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', ItemReg.RUBY.get())
                ...
                .unlockedBy("elevator", InventoryChangeTrigger.TriggerInstance.hasItems(ItemReg.POLE.get()))
                .save(p_251297_);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ItemReg.JADEITE_GREATSWORD.get())
                .pattern(" a ")
                .pattern(" a ")
                .pattern(" b ")
                .define('a', ItemReg.JADEITE.get())
